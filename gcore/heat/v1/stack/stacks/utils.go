...
func (t *TE) Fetch() error {
	...
	u, err := gcorecloud.NormalizePathURL(t.baseURL, t.URL)
	if err != nil {
		return err
	}
	t.URL = u
...
func getBasePath() (string, error) {
	...
	u, err := gcorecloud.NormalizePathURL("", basePath)
	if err != nil {
		return "", err
	}
	return u, nil
...
func toStringKeys(m interface{}) (map[string]interface{}, error) {
	...
	case map[string]interface{}, map[interface{}]interface{}:
		...
		return typedMap, nil
	default:
		return nil, gcorecloud.ErrUnexpectedType{Expected: "map[string]interface{}/map[interface{}]interface{}", Actual: fmt.Sprintf("%v", reflect.TypeOf(m))}
	}
}
